...
{
    public partial class FPdatabaseContext : DbContext
    {
        public FPdatabaseContext()
        {
        }

        public FPdatabaseContext(DbContextOptions<FPdatabaseContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Data Source=Gauravmi-VD3;Initial Catalog=FPdatabase;Persist Security Info=True;User ID=sa;Password=cybage@123456");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Buyer>(entity =>
            {
                ...
                entity.HasIndex(e => e.BuyerEmail, "UQ__Buyer__C654510FF9344069")
                    .IsUnique();
            ...
            modelBuilder.Entity<Provider>(entity =>
            {
                ...
                entity.HasIndex(e => e.ProviderEmail, "UQ__Provider__D9C300DE66DA687B")
                    .IsUnique();
            ...
            modelBuilder.Entity<Seller>(entity =>
            {
                ...
                entity.HasIndex(e => e.SellerEmail, "UQ__Seller__55F828C0E5077CE7")
                    .IsUnique();
            ...
            modelBuilder.Entity<WebsiteHistory>(entity =>
            {
                entity.HasKey(e => e.TransactionId)
                    .HasName("PK__WebsiteH__55433A6B4B295689");
